...
st.markdown("""
    <style>
        ...
        /* --- HIGH PERFORMANCE NATIVE SLIDER COLOR INJECTION --- */
        /* Targets the precise key generated by Streamlit's aria-label specifications */
        
        /* RED SLIDER */
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Red Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Red Channel (VDP)"]) div[role="slider"],
        .stSlider:has(input[aria-label="Red Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        .stSlider:has(input[aria-label="Red Channel (VDP)"]) div[role="slider"] {
        ...
        /* GREEN SLIDER */
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Green Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Green Channel (VDP)"]) div[role="slider"],
        .stSlider:has(input[aria-label="Green Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        .stSlider:has(input[aria-label="Green Channel (VDP)"]) div[role="slider"] {
        ...
        /* BLUE SLIDER */
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Blue Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        div[data-testid="stWidgetFormSubmitWrapper"] + div .stSlider:has(input[aria-label="Blue Channel (VDP)"]) div[role="slider"],
        .stSlider:has(input[aria-label="Blue Channel (VDP)"]) div[data-testid="stSliderTrack"] > div > div,
        .stSlider:has(input[aria-label="Blue Channel (VDP)"]) div[role="slider"] {
